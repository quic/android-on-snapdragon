...
public class Hdr10Encode {
  private final static String TAG = "TRANSFER_HDR10";
  ...
  public Hdr10Encode(MainActivity activity) {
    mainActivity = activity;
  }

  void runHDR10_Encode(String fileInput, String fileOut, int Bitrate, int FRAME_INTERVAL)
      throws Exception {
  ...
  private void SetHDR10_Encode() {
    EncoderFormat.setInteger(MediaFormat.KEY_PROFILE, MediaCodecInfo.CodecProfileLevel.HEVCProfileMain10HDR10);
