...
public class Hdr10PlusEncode {
  private final static String TAG = "TRANSFER_HDR10_Plus";
  ...
  public Hdr10PlusEncode(MainActivity activity) {
    mainActivity = activity;
  }

  void runHDR10_Plus_Encode(String fileInput, String fileOut, int Bitrate, int FRAME_INTERVAL)
      throws Exception {
  ...
  private void SetHDR10_Plus_Encode() {
    EncoderFormat.setInteger(MediaFormat.KEY_PROFILE, MediaCodecInfo.CodecProfileLevel.HEVCProfileMain10HDR10Plus);
    EncoderFormat.setInteger(MediaFormat.KEY_LEVEL, MediaCodecInfo.CodecProfileLevel.HEVCHighTierLevel51);
  }
