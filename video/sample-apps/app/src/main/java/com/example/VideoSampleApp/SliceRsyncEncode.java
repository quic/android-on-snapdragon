...
public class SliceRsyncEncode {
  ...
  private void start() throws Exception {
    if (!supportedExtensions.contains(QMediaExtensions.KEY_RESYNC_MARKER_SIZE))
      throw new Exception("KEY_RESYNC_MARKER_SIZE Not supported ");
    if (!supportedExtensions.contains(QMediaExtensions.KEY_SLICE_SPACING_SIZE))
